...
public class Lehoia extends Karta {
	...
	public Lehoia(int pId,String pIzena,String pDeskr,boolean pErre,int pPuntuak,String pKolorea){
		...
		if (Tableroa.getTableroa().getMahaiKartak().contains(Tximinoa)) {//TENEMOS QUE TENER LA POSIBILIDAD DE ACCEDER A CUALQUIER KARTA, ES DECIR HACES UNA LISTA KARTAK DONDE ESTEN TODAS
